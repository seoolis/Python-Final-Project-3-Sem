...
path = 'D:/Project/Python/django-web-app/project/csv_files/'
...
combined_data.to_csv('D:/Project/Python/django-web-app/project/all_skills_by_year.csv', index=False, encoding='utf-8', sep='|')

print("Новый файл успешно создан: all_skills_by_year.csv")
